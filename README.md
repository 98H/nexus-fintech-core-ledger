...
[![Live Deployment](https://img.shields.io/badge/Deployment-Live%20Preview-8b5cf6?style=for-the-badge)](/preview/prod-fintech-core-ledger-45eae2/)
...
- **پیوند دسترسی زنده (Live Preview):** [/preview/prod-fintech-core-ledger-45eae2/](/preview/prod-fintech-core-ledger-45eae2/)
...
```bash
# ۱. کلون ریپازیتوری
git clone https://github.com/98H/nexus-fintech-core-ledger.git
cd nexus-fintech-core-ledger
...
- **تاریخ آخرین همگام‌سازی:** 2026-09-19 16:14:48 UTC